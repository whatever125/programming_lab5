...
public class MovieArgumentChecker extends ArgumentChecker {
     ...
     */
    public static void checkArguments(String name, Coordinates coordinates, long oscarsCount, MovieGenre genre, MpaaRating mpaaRating, Person director) {
     ...
     * @param oscarsCount - the number of oscars the movie has won
     */
    public static void checkOscarsCount(long oscarsCount) {
     ...
     * @param genre - the genre of the movie
     */
    public static void checkGenre(MovieGenre genre) {
     ...
     * @param mpaaRating - the rating of the movie
     */
    public static void checkMpaaRating(MpaaRating mpaaRating) {
     ...
     * @param director - the director of the movie
     */
    public static void checkDirector(Person director) {
